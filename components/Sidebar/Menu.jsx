        ...
        menu?.items ?
            ...
            <Link
                ...
                className={` ${menu?.margin && "mt-4"
                    } group flex items-center text-md  gap-3.5 font-medium py-2 px-2 hover:bg-primary rounded-md border-b transition-all ease-in duration-200`}>
                <div>{React.createElement(menu?.icon, { size: "20" })}</div>
                <h2
                    style={{
                        transitionDelay: `${index + 3}00ms`,
                ...
                <h2
                    className={`${open && "hidden"
                        } absolute overflow-visible left-48 bg-primary font-semibold whitespace-pre text-gray-900 rounded-md drop-shadow-lg px-0 py-0 w-0 group-hover:px-2 group-hover:py-1 group-hover:left-14 group-hover:duration-300 group-hover:w-fit `}>
