        ...
        menu?.items ?
            ...
            <>
                <div
                    ...
                    // href={'/'}
                    key={index}
                    className={` ${menu?.margin && "mt-4", path.includes(menu?.link) && "border-l-8 border-l-white"} group flex items-center text-md  gap-3.5 py-2 px-2 hover:bg-secondary rounded-md border-b transition-all ease-in duration-200`}>
                    ...
                    <h2
                        className={`${open ? "group-hover:left-[232px]" : " group-hover:left-12"} absolute left-48 bg-primary whitespace-pre text-gray-900 rounded-md drop-shadow-lg px-0 py-0 w-0 overflow-hidden group-hover:px-2 group-hover:py-1 group-hover:duration-300 group-hover:w-fit `}>
                        <p className='py-2'>
                            {
